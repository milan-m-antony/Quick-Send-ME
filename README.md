...
- Simple sender/receiver flow with 6-digit transfer code
- Multi-file and two-way transfer support (send and receive in one session)
- Built-in in-session chat (available only on the main transfer page)
- Clean mobile and desktop interface
- Privacy-focused user flow (no file storage on server)
...
![Transfer Complete](images/transfer-complete.png)
